...
i686-elf-gcc -T linker.ld -o build/basic_os.bin -ffreestanding -O2 -nostdlib build/gdts.o build/gdt.o build/file.o build/idt.o build/idts.o build/mem.o build/shell.o build/boot.o build/kernel.o build/stdio.o build/tty.o build/string.o build/io.o build/keyboard.o -lgcc
