...
i686-elf-gcc -T linker.ld -o build/myos.bin -ffreestanding -O2 -nostdlib build/shell.o build/boot.o build/kernel.o build/stdio.o build/tty.o build/string.o build/io.o build/keyboard.o -lgcc
